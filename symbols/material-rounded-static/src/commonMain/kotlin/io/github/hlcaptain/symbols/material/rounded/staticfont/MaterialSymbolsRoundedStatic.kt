 ...
 */
public object MaterialSymbolsRoundedStatic : MaterialSymbolRegularFont {
...
/** Renders [symbol] with the bundled API-21-compatible static Rounded font. */
@Composable
public fun MaterialSymbolIcon(
    symbol: RoundedMaterialSymbol,
    contentDescription: String?,
    modifier: Modifier = Modifier,
    axes: MaterialSymbolAxes = MaterialSymbolsRoundedStatic.axes,
