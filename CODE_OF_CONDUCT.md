...
reported privately to the project maintainers. Use the private reporting
channel described in [SECURITY.md](SECURITY.md) and begin the report title with
`[Code of Conduct]`. If that channel is unavailable, request a private contact
channel without including report details in public.
