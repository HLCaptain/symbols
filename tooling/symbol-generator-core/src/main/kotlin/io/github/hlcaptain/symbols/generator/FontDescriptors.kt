...
internal class KotlinFontDescriptorsRenderer {
    fun render(
        ...
        val contents = buildString {
            ...
            descriptors
                ...
                appendDescriptor(visibilityPrefix, resClassName, descriptor)
            }
            appendLine("}")
            appendLine()
            appendLine("${visibilityPrefix}val $resClassName.symbolFonts: SymbolFonts")
    ...
    private fun StringBuilder.appendDescriptor(
        ...
        appendLine("    ${visibilityPrefix}val ${descriptor.accessorName}: SymbolFont.$fontType =")
